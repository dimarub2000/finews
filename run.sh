...
nohup python3 parsers/bin/main.py > parsers/parsers.out 2> parsers/parsers.err &
nohup python3 tg_bot/tg_bot_finews.py > tg_bot/tg_bot.out 2> tg_bot/tg_bot.err &
